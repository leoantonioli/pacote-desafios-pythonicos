...
def sort_last(tuples):
    tuples.sort(key=ultimo) #  key dá uma função a ser chamada para cada elemento da lista (cada tupla, nesse caso)
    return tuples

def ultimo(tupla):
    return tupla[-1] #  Aqui é selecionado o último elemento de cada tupla
